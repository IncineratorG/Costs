package com.touristskaya.expenses.refactor_v1_active.activities.backup;
...
import com.touristskaya.expenses.refactor_v1_active.common.types.reactive.realisation.Subscription;
...
import com.touristskaya.expenses.refactor_v1_active.stores.common.Payload;
import com.touristskaya.expenses.refactor_v1_active.stores.realisation.Stores;
import com.touristskaya.expenses.refactor_v1_active.stores.realisation.backup.BackupActionsFactory;
import com.touristskaya.expenses.refactor_v1_active.stores.realisation.backup.BackupState;
import com.touristskaya.expenses.refactor_v1_active.stores.realisation.backup.types.BackupData;
import com.touristskaya.expenses.refactor_v1_active.stores.realisation.backup.types.CreateDeviceBackupStatus;
import com.touristskaya.expenses.refactor_v1_active.stores.realisation.backup.types.DeleteDeviceBackupStatus;
import com.touristskaya.expenses.refactor_v1_active.stores.realisation.backup.types.DriveServiceBundle;
        ...
        mCreateDeviceBackupSubscription = mBackupState.createDeviceBackupStatus.subscribe(() -> {
            ...
            switch (createDeviceBackupStatus) {
                ...
                case CreateDeviceBackupStatus.NotComplete: {
                    ...
                    // Удаляем не полностью созданную резервную копию.
                    String backupFolderId = mBackupState.createDeviceBackupStatus.get().getBackupFolderId();
